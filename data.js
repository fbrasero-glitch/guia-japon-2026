...
const travelData = [
    ...
    // --- DÍA 5: NARA y SUR (ESTRUCTURA BASE + COMPLEMENTOS) ---
    {
        day: 5, type: "stay",
        date: "Vie, 31 Julio", title: "🦌 Nara: Ciervos y Tradición",
        ...
        logistics: [
            { title: "Transporte", text: "Tren JR Yamatoji Line desde Osaka." },
            { title: "Ciervos", text: "Cuidado con los mapas y comida, muerden." }
        ],

        timeline: [
            { time: "08:30", title: "Fushimi Inari Taisha", desc: "Parada estratégica de camino. Subir al mirador. (Base)" },
            { time: "11:00", title: "Nara Park y Todai-ji", desc: "Gran Buda y ciervos sagrados. (Base)" }
        ],

        prices: {
            transport: "~1.000 JPY",
            entrances: "600 JPY (Todai-ji) + 600 JPY (Byodo-in Opcional)",
            food: "~3.000 JPY",
        ...
        base: {
            title: "Itinerario Base",
            description: "Ruta clásica por la primera capital y el santuario infinito.",
            events: [
                {
                    id: "b1",
                    time: "08:30",
                    title: "Fushimi Inari Taisha",
                    description: "Santuario de las 10.000 puertas torii. Subida al mirador Yotsutsuji.",
                    image: "images/dia6-fushimi.jpg",
                    price: "Gratis",
                    fullDesc: `
                        <h3><i class="fa-solid fa-torii-gate"></i> Fushimi Inari</h3>
                        <p>Famoso por sus miles de toriis rojos que serpentean por el monte Inari.</p>
                        <ul>
                            <li><i class="fa-regular fa-clock"></i> <strong>Visita:</strong> Subiremos hasta el mirador Yotsutsuji para ver Kioto desde arriba (sin llegar a la cima para ahorrar tiempo/energía).</li>
                        </ul>
                    `,
                    video: "https://www.youtube.com/watch?v=fXfS6_0D6iU"
                },
                {
                    time: "10:30",
                    title: "Traslado a Nara",
                    description: "Tren JR hacia Nara Park.",
                    type: "gap"
                },
                {
                    id: "b2",
                    time: "11:00",
                    title: "Nara Park y Templo Todai-ji",
                    description: "Parque con ciervos libres y el Buda de bronce más grande del mundo.",
                    image: "images/dia4-nara.jpg",
                    price: "600 JPY",
                    fullDesc: `
                        <h3><i class="fa-solid fa-landmark"></i> Templo Todai-ji</h3>
                        <p>Hogar del 'Daibutsu' (Gran Buda). Es la construcción de madera más grande del mundo.</p>
                        <p><strong>Nara Park:</strong> Podrás alimentar a los ciervos sagrados con galletas Shika-senbei.</p>
                    `,
                    video: "https://www.youtube.com/watch?v=JmYIun1I780",
                    ivanChallenge: "Atraviesa el agujero del 'Pilar de la Nariz de Buda' en el Todai-ji. ¡Dicen que otorga iluminación en la próxima vida!"
                },
                {
                    time: "13:30",
                    title: "Tarde Libre / Opcionales",
                    description: "Espacio para Kasuga Taisha o traslado a Uji.",
                    type: "gap"
                }
            ]
        },
        complements: [
            {
                ...
                time: "13:30",
                description: "Templo de los faroles de piedra (dentro del parque Nara).",
                price: "500 JPY",
                image: "images/dia4-nara.jpg"
            },
            {
                id: "c2",
                title: "Parada en Uji (Byodo-in)",
                time: "16:00",
                description: "A la vuelta. Templo de la moneda de 10 yenes y té matcha.",
                price: "600 JPY",
                image: "images/dia4-nara.jpg"
            }
        ]
    ...
    // --- DÍA 6: TRASLADO A KIOTO (ESTRUCTURA BASE + COMPLEMENTOS) ---
    {
        day: 6, type: "travel",
        date: "Sáb, 1 Agosto", title: "👘 Kioto: Llegada y Gion",
        ...
        logistics: [
            { title: "Maletas", text: "Dejadlas en el hotel antes del check-in (15:00)." },
            { title: "Transporte", text: "Tren JR Special Rapid desde Osaka (29 min)." }
        ],

        timeline: [
            { time: "10:00", title: "Check-out Osaka y Tren", desc: "Traslado a la antigua capital. (Base)" },
            { time: "17:00", title: "Gion y Pontocho", desc: "Paseo buscando Geishas y cena junto al río. (Base)" }
        ],
        ...
        prices: {
            ...
            entrances: "Gratis",
            food: "~3.500 JPY",
            total: "~4.100 JPY (Base)"
        },

        isFlexible: true,
        base: {
            title: "Itinerario Base",
            description: "Llegada a Kioto y primera toma de contacto nocturna.",
            events: [
                {
                    id: "b1",
                    time: "10:00",
                    title: "Check-out y Tren a Kioto",
                    description: "Traslado en JR Special Rapid. Dejar maletas en hotel.",
                    image: "images/dia2-osaka.jpg",
                    price: "570 JPY",
                    fullDesc: `
                        <h3><i class="fa-solid fa-train"></i> Traslado a Kioto</h3>
                        <p>Daremos el salto a la capital cultural de Japón. El trayecto dura menos de 30 minutos.</p>
                    `
                },
                {
                    time: "11:30",
                    title: "Tiempo para Almorzar",
                    description: "Recomendamos el Mercado Nishiki o la Estación de Kioto.",
                    type: "gap"
                },
                {
                    id: "b2",
                    time: "17:00",
                    title: "Gion y Pontocho",
                    description: "Distrito de las Geishas y callejón gastronómico tradicional.",
                    image: "images/dia6-portada.jpg",
                    price: "Gratis",
                    fullDesc: `
                        <h3><i class="fa-solid fa-person-dress-fairy"></i> Distrito de Gion</h3>
                        <p>Paseo al atardecer por Hanami-koji. Cruzaremos el puente Shijo hacia Pontocho para cenar frente al río Kamo.</p>
                    `,
                    video: "https://www.youtube.com/watch?v=S0T-X1CAnmI"
                }
            ]
        },
        complements: [
            {
                ...
                time: "12:30",
                description: "Almuerzo en el mercado tradicional del centro de Kioto.",
                price: "Variable",
                image: "images/dia6-portada.jpg"
            }
        ]
    ...
    // --- DÍA 7: HIGASHIYAMA (ESTRUCTURA BASE + COMPLEMENTOS) ---
    {
        day: 7, type: "stay",
        date: "Dom, 2 Agosto", title: "🌸 Kioto Clásico: Templos y Geishas",
        ...
        logistics: [
            { title: "Transporte", text: "Taxi a Kiyomizu (recomendado 8 personas)." },
            { title: "Caminata", text: "Día de mucho andar por cuestas empedradas." }
        ],

        timeline: [
            { time: "09:00", title: "Kiyomizu-dera", desc: "Templo del agua pura y terraza de madera. (Base)" },
            { time: "11:00", title: "Sannenzaka y Ninenzaka", desc: "Calles tradicionales preservadas. (Base)" }
        ],
        ...
        base: {
            title: "Itinerario Base",
            description: "El corazón histórico y turístico de Kioto.",
            events: [
                {
                    id: "b1",
                    time: "09:00",
                    title: "Kiyomizu-dera",
                    description: "Templo colgado de la montaña. Terraza sin clavos.",
                    image: "images/dia7-kiyomizu.jpg",
                    price: "400 JPY",
                    fullDesc: `
                        <h3><i class="fa-solid fa-water"></i> Templo Kiyomizu-dera</h3>
                        <p>Fundado en 778. Su terraza de madera ofrece las vistas más icónicas de Kioto. Se construyó sin usar un solo clavo.</p>
                        <ul>
                            <li><i class="fa-solid fa-heart"></i> <strong>Iván Reto:</strong> Busca las 'Piedras del Amor'. Camina de una a otra con los ojos cerrados para tener suerte.</li>
                            <li><i class="fa-solid fa-faucet"></i> <strong>Fuente Otowa:</strong> Bebe de un solo chorro (Salud, Amor o Éxito). ¡No de los tres!</li>
                        </ul>
                    `,
                    video: "https://www.youtube.com/watch?v=wX-yP_XwT7Y"
                },
                {
                    id: "b2",
                    time: "11:00",
                    title: "Sannenzaka y Ninenzaka",
                    description: "Cuestas empedradas con casas tradicionales de madera.",
                    image: "images/dia7-kiyomizu.jpg",
                    price: "Gratis",
                    fullDesc: `
                        <h3><i class="fa-solid fa-person-walking"></i> Cuestas de Higashiyama</h3>
                        <p>El Kioto de postal. Tiendas de artesanía, cerámica y dulces.</p>
                        <p><strong>Advertencia:</strong> La leyenda dice que si caes en Sannenzaka, morirás en 3 años. ¡Pisa con cuidado!</p>
                    `
                },
                {
                    time: "13:00",
                    title: "Almuerzo en Gion",
                    description: "Tiempo para comer y descansar antes de los opcionales.",
                    type: "gap"
                }
            ]
        },
        complements: [
            {
                id: "c1",
                title: "Ruta del Filósofo (Ginkaku-ji)",
                time: "14:00",
                description: "Pabellón de Plata (Ginkaku-ji) y paseo zen junto al canal.",
                price: "500 JPY",
            ...
            },
            {
                ...
                title: "Sanjusangendo",
                time: "16:30",
                description: "Templo con 1001 estatuas de Kannon. Impresionante vista.",
                price: "600 JPY",
                image: "images/dia7-portada.jpg"
            }
        ]
    ...
    // --- DÍA 8: ARASHIYAMA y NORTE (ESTRUCTURA BASE + COMPLEMENTOS) ---
    {
        ...
        timeline: [
            { time: "08:00", title: "Bosque de Bambú", desc: "La luz entra entre los tallos. (Base)" },
            { time: "09:30", title: "Templo Tenryu-ji", desc: "Jardín zen patrimonio de la humanidad. (Base)" }
        ],

        prices: {
            transport: "500 JPY",
            entrances: "500 JPY (Tenryu-ji) + 800 JPY (Opciones)",
            food: "~3.000 JPY",
            total: "~4.000 JPY (Base)"
        },
            ...
            events: [
                {
                    ...
                    description: "Paseo icónico entre tallos gigantes. Id muy temprano para evitar multitudes.",
                    image: "images/dia8-bambu.jpg",
                    price: "Gratis",
                    fullDesc: `
                        <h3><i class="fa-solid fa-leaf"></i> Bosque de Bambú de Arashiyama</h3>
                        <p>Uno de los paisajes más fotografiados de Japón. El sonido del viento entre los tallos es considerado uno de los '100 sonidos a preservar' por el gobierno japonés.</p>
                        <p><strong>Tip:</strong> A las 08:00 la luz es mágica y hay poca gente.</p>
                    `,
                ...
                },
                {
                    ...
                    description: "El dragón celestial. Jardín Sogenchi con técnica Shakkei.",
                    image: "images/dia8-bambu.jpg",
                    price: "500 JPY",
                    fullDesc: `
                        <h3><i class="fa-solid fa-dragon"></i> Templo Tenryu-ji</h3>
                        <p>Principal templo de la escuela Rinzai. Su jardín zen del s. XIV usa las montañas de Arashiyama como 'paisaje prestado'.</p>
                        <ul>
                            <li><i class="fa-solid fa-camera"></i> <strong>Foto:</strong> El reflejo del jardín en el estanque Sogenchi.</li>
                        </ul>
                    `
                },
                {
                    time: "11:30",
                    title: "Tiempo para Almuerzo / Traslado",
                    description: "Caminata por el puente Togetsukyo o almuerzo local.",
                    type: "gap"
                }
            ]
        },
        complements: [
            {
                ...
                time: "10:30",
                description: "Subida de 20 min. Macacos en libertad y vistas de la ciudad.",
                price: "550 JPY",
                image: "images/dia8-bambu.jpg",
                recommended: true
            },
            {
                ...
                time: "14:00",
                description: "El templo cubierto de oro puro. Imprescindible.",
                price: "500 JPY",
                image: "images/dia7-ginkakuji.jpg"
            },
            {
                ...
                title: "Ryoan-ji",
                time: "15:30",
                description: "El jardín seco (karesansui) más famoso. 15 piedras que no se ven a la vez.",
                price: "500 JPY",
                image: "images/dia7-ginkakuji.jpg"
            }
        ]
    ...
    // --- DÍA 9: HIMEJI (ESTRUCTURA BASE + COMPLEMENTOS) ---
    {
        day: 9, type: "stay",
        date: "Mar, 4 Agosto", title: "🏰 Himeji: El Castillo Blanco",
        ...
        logistics: [
            { title: "Transporte", text: "Shinkansen a Himeji (55 min). Reservad asientos." },
            { title: "Calor", text: "El castillo es una subida intensa. Llevad agua." }
        ],

        timeline: [
            { time: "08:30", title: "Shinkansen", desc: "Trayecto rápido a Himeji. (Base)" },
            { time: "10:00", title: "Castillo Himeji", desc: "El mejor conservado de Japón. (Base)" },
            { time: "13:30", title: "Monte Shosha", desc: "Escenario de 'El Último Samurái'. (Opcional)" }
        ],

        prices: {
            transport: "~10.000 JPY (Shinkansen) o Gratis (JR Pass si tuvierais)",
            entrances: "1.000 JPY (Castillo)",
            food: "~3.000 JPY",
            total: "~14.000 JPY (Base)"
        },

        isFlexible: true,
        base: {
            title: "Itinerario Base",
            description: "Excursión al castillo más espectacular de Japón.",
            events: [
                {
                    id: "b1",
                    time: "08:30",
                    title: "Traslado en Shinkansen",
                    description: "Viaje rápido a Himeji (55 min).",
                    price: "~5.000 JPY"
                },
                {
                    id: "b2",
                    ...
                    description: "La Garza Blanca. Castillo original Patrimonio de la Humanidad.",
                    image: "images/dia9-himeji.jpg",
                    price: "1.000 JPY",
                    fullDesc: `
                        <h3><i class="fa-solid fa-chess-rook"></i> Castillo de Himeji</h3>
                        <p>El mejor conservado de Japón. Su estructura de madera es original y su sistema defensivo de laberintos era inexpugnable.</p>
                        <p><strong>Visita:</strong> Hay que descalzarse. Se suben 6 plantas por escaleras muy empinadas.</p>
                    `,
                    video: "https://www.youtube.com/watch?v=Fst5jY_w7rM",
                    ivanChallenge: "Encuentra la 'Ventana de la Viuda' o los huecos para lanzar piedras (Ishi-otoshi). ¡Un castillo diseñado para la guerra!"
                },
                {
                    time: "13:00",
                    title: "Tiempo de Almuerzo",
                    description: "Tiempo para comer en Himeji antes de seguir.",
                    type: "gap"
                }
            ]
        },
        complements: [
            {
                ...
                title: "Monte Shosha",
                time: "13:30",
                description: "Templos en la montaña (El Último Samurái).",
                price: "1.000 JPY",
                image: "images/dia9-himeji.jpg",
                recommended: true
            },
            {
                id: "c2",
                title: "Castillo Nijo (Kioto)",
                time: "16:30",
                description: "Si volvéis pronto a Kioto. Residencia del Shogun.",
                price: "1.300 JPY",
    ...
    // --- DÍA 10: DESPEDIDA DE KIOTO (ESTRUCTURA BASE + COMPLEMENTOS) ---
    {
        ...
        timeline: [
            ...
            { time: "10:00", title: "Tiempo Libre", desc: "Elegid complementos. (Base)" }
        ],
        ...
        prices: {
            ...
            entrances: "Variable",
            food: "~3.000 JPY",
            total: "~3.000 JPY (Base)"
        },

        isFlexible: true,
        base: {
            title: "Itinerario Base",
            description: "Mañana de logística y despedida.",
            events: [
                {
                    id: "b1",
                    time: "09:00",
                ...
                {
                    time: "10:30",
                    title: "Mañana Libre en Kioto",
                    description: "Últimas compras en Nishiki o visita a Ohara.",
                    type: "gap"
                }
            ]
        },
        complements: [
            {
                ...
                time: "10:00",
                description: "Jardines de musgo y estatuas Jizo. Al norte de Kioto.",
                price: "700 JPY",
            ...
            },
            {
                ...
                time: "10:00",
                description: "Vistas panorámicas frente a la estación.",
                price: "900 JPY",
            ...
            },
            {
                ...
                time: "12:30",
                description: "Últimas compras gastronómicas.",
                price: "Gratis",
